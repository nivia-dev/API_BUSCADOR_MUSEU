...
function Home() {
    ...
    const fetchUfs = async () => {
        try {
            const response = await axios.get('http://localhost:3000/api/ufs');
    ...
    const fetchData = async () => {
        try {
            const response = await axios.get('http://localhost:3000/api/museus', {
                params: {
                    pagina,
                    limite,
    ...
    const fetchSearchData = async () => {
        try {
            const response = await axios.get('http://localhost:3000/api/pesquisa', {
                params: {
                    termo: buscaTermo
                }
            });
